...
sys.argv = ['../Data/KEGG_Annotations']
...
unclean_master = master_df[~(b1 & b2)]
b3 = unclean_master.K_number_1.isnull()
b4 = unclean_master.KO_Annot_1.isnull()

print "All annotation classification scores (n={})".format(unclean_master.shape[0])
print "\tMean: {}".format(unclean_master.GHOSTX_score.mean())
print "\tSTD: {}".format(unclean_master.GHOSTX_score.std())
print "\tMax: {}".format(unclean_master.GHOSTX_score.max())
print "\tMin: {}".format(unclean_master.GHOSTX_score.min())

just_K_nums = unclean_master[~b3 & b4]
...
keeping_on_purpose = ["K03421", "K03422", "K00399", "K00400", "K00401", "K00402"]
manual_override = unclean_master.K_number_1.isin(keeping_on_purpose)
cleaner_master = unclean_master[(unclean_master.GHOSTX_score > 100) | manual_override ]


clean_master = cleaner_master[ordered_cols]
...
select_K_nums = ["K00362", "K00363", "K00368", "K00370", "K00371", "K00376", "K00394", 
                 ...
                 "K17226", "K17227", "K03421", "K03422", "K08928", "K08929", "K00855"]



select_bools_1 = clean_master.KO_Annot_1.isin(select_K_nums)
select_bools_2 = clean_master.KO_Annot_2.isin(select_K_nums)
select_bools_3 = clean_master.KO_Annot_3.isin(select_K_nums)
select_bools_4 = clean_master.K_number_1.isin(select_K_nums)
select_bools_5 = clean_master.K_number_2.isin(select_K_nums)
select_bools_6 = clean_master.K_number_3.isin(select_K_nums)
select_master = clean_master[select_bools_1 | select_bools_2 | select_bools_3 | select_bools_4 | select_bools_5 | select_bools_6]
